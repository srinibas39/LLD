...
abstract class Car {
    ...
    public abstract void honking(String sound);
}
...
class ManualCar extends Car {
    ...
    @Override
    public void honking(){
        System.out.println("Loud honking");

    }

    @Override
    public void honking(String sound){
...
public class StaticAndDynamicPolymorphism {
    public static void main(String[] args) {
        ...
        myElectricCar.honking();
        myElectricCar.honking("Small Boom");
    }
}